...
export default function ProductBio({ onClick }) {
  return (
    <>
      <div className="rounded-lg flex flex-col shadow-xl pb-5 gap-5 cursor-pointer">
        <img src={ball} alt="ball" className="h-3/4" onClick={onClick} />
        <div
          className="flex items-center justify-center gap-14 px-3.5"
          onClick={onClick}
        >
